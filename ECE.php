...
<head>
	<title>We got all the greenery!</title>
							...
							<table>
								...
								<tr>
									<td class="tbl">
										...
										<div align="center">
											<input type="range" name="Personality" class="slider2" min="1" max="100" value="20">
										</div>
									</td>
									...
									<td class="tbl">
										...
										<div align="center">
											<input type="range" name="Compatibility" class="slider2" min="1" max="100" value="20">
										</div>
									</td>
									...
									<td class="tbl">
										...
										<div align="center">
											<input type="range" name="Cleanliness" class="slider2" min="1" max="100" value="20">
										</div>
									</td>
									...
									<td class="tbl">
										...
										<div align="center">
											<input type="range" name="Education" class="slider2" min="1" max="100" value="20">
										</div>
									</td>
									...
									<td class="tbl">
										...
										<div align="center">
											<input type="range" name="Studies" class="slider2" min="1" max="100" value="20">
										</div>
									</td>
									...
									<td class="tbl">
										...
										<div align="center">
											<input type="range" name="Language" class="slider2" min="1" max="100" value="20">
										</div>
									</td>
									...
									<td class="tbl">
										...
										<div align="center">
											<input type="range" name="Cognizance" class="slider2" min="1" max="100" value="20">
										</div>
									</td>
									...
									<td class="tbl">
										...
										<div align="center">
											<input type="range" name="Humorous" class="slider2" min="1" max="100" value="20">
										</div>
									</td>
									...
									<td class="tbl">
										...
										<div align="center">
											<input type="range" name="Conclusion" class="slider2" min="1" max="100" value="20">
										</div>
									</td>
								</tr>
				...
				<table>
					<tr>
						<td class="tbl">
							...
							<div align="center">
								<input type="range" name="prsnlty" id="rng" class="slider" min="1" max="100" value="<?php echo ($person); ?>">
							</div>
						</td>
						<td class="tbl">
							<div align="center">
							...
							<div align="center">
								<input type="range" name="cmptblty" id="rng" class="slider" min="1" max="100" value="<?php echo ($compat); ?>">
							</div>
						</td>
						...
						<td class="tbl">
							...
							<div align="center">
								<input type="range" name="clnlnss" id="rng" class="slider" min="1" max="100" value="<?php echo ($clean); ?>">
							</div>
						</td>
						...
						<td class="tbl">
							...
							<div align="center">
								<input type="range" name="dctn" id="rng" class="slider" min="1" max="100" value="<?php echo ($edu); ?>">
							</div>
						</td>
						...
						<td class="tbl">
							...
							<div align="center">
								<input type="range" name="dctn" id="rng" class="slider" min="1" max="100" value="<?php echo ($stud); ?>">
							</div>
						</td>
						...
						<td class="tbl">
							...
							<div align="center">
								<input type="range" name="lngg" id="rng" class="slider" min="1" max="100" value="<?php echo ($lang); ?>">
							</div>
						</td>
						...
						<td class="tbl">
							...
							<div align="center">
								<input type="range" name="cgnznc" id="rng" class="slider" min="1" max="100" value="<?php echo ($cog); ?>">
							</div>
						</td>
						...
						<td class="tbl">
							...
							<div align="center">
								<input type="range" name="hmr" id="rng" class="slider" min="1" max="100" value="<?php echo ($humor); ?>">
							</div>
						</td>
						...
						<td class="tbl">
							...
							<div align="center">
								<input type="range" name="cnclsn" id="rng" class="slider" min="1" max="100" value="<?php echo ($conc); ?>">
							</div>
						</td>
					</tr>
				</table>
