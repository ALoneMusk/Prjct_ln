<style type="text/css">
    ...
    @media only screen and (min-width:481px) {
        ...
        .dropdown_content_header a:hover {
            background-color: #ddd;
        }

        .dropdown_header:hover .dropdown_content_header {
            display: block;
        }

        .dropdown_header:hover .dropbutton_header {
            background-color: #833AB4;
        }
...
<div class="top_bar_header_web">
    ...
    <a href="index.php"><img style="position: absolute;top:2%;left:12%;" src="img/logo.png" class="logocircle" title=" logo" width="65px" height="58px" /></a>
    <?php
    ...
    <?php
    if (isset($_SESSION['loggedin'])) {
        echo "<button onclick=\"window.location.href = 'addque.php';\" class=\"contri\"><b>Contribute</b></button>";
    }
    ?>
</div>